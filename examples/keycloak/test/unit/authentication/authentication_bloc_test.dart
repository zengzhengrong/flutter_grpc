...
void main() {
  ...
  setUp(() {
    ...
    authenticationBloc = AuthenticationBloc(userRepository: userRepository,oauth2: oatuh2, keycloakBloc: keycloakBloc);
  });
  ...
  test('throws AssertionError when userRepository is null', () {
    expect(
      () => AuthenticationBloc(userRepository: null,oauth2: null, keycloakBloc: null),
